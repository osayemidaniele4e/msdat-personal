    ...
    <div class="table-responsive">
      <table class="table table-bordered align-middle text-nowrap">
        <tbody>
          <tr>
            ...
            >
              <div class="d-flex justify-content-between align-items-center">
                ...
                <span id="reset"><b-icon-arrow-clockwise /></span>
              </div>
            </th>
          ...
          <template>
            <TableDataRow rowData="indicatorData">
              <!-- <template>
...
import TableDataRow from '../../msdat-dashboard/components/table/TableDataRow.vue';
...
export default {
  ...
  //         (a, b) =>
  //           this.classificationOrder.indexOf(a[0]) -
...
// //       const arraySource = this.dataArray.map((e) =>
// //         e.values.map((et) => et.dataSources)
// //       );
