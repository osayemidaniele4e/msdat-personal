  ...
  methods: {
    ...
    triangulate() {
      ...
      this.headers = this.tempData
        ...
        .filter((header, index, self) => self.indexOf(header) === index); // Remove duplicates
    ...
    //   this.sources = data.flatMap((entry) => Object.keys(entry));
    ...
    //     if (source === 'aggregate' && Array.isArray(sourceData)) {
    //       sourceData.forEach((agg) => {
    //         const aggSource = Object.keys(agg)[0];
    //         const aggData = agg[aggSource];

    //         if (aggData.complementarity?.grades) {
    //           Object.entries(aggData.complementarity.grades).forEach(([key, value]) => {
    //             if (!complementarity[key]) {
    //               complementarity[key] = { metric: key, values: {} };
    //             }
    ...
    //         if (aggData.consistency?.grades) {
    //           Object.entries(aggData.consistency.grades).forEach(([key, value]) => {
    //             if (!consistency[key]) {
    //               consistency[key] = { metric: key, values: {} };
    //             }
    ...
    //       if (sourceData.complementarity?.grades) {
    //         Object.entries(sourceData.complementarity.grades).forEach(([key, value]) => {
    //           if (!complementarity[key]) {
    //             complementarity[key] = { metric: key, values: {} };
    //           }
    ...
    //       if (sourceData.consistency?.grades) {
    //         Object.entries(sourceData.consistency.grades).forEach(([key, value]) => {
    //           if (!consistency[key]) {
    //             consistency[key] = { metric: key, values: {} };
    //           }
    ...
    //   console.log(this.gradedData, 'Triangulation 1');
    //   console.log(result, 'Triangulation 2');
    //   return result;
    // },
    ...
    //     if (entry.aggregate) {
    //       return entry.aggregate.map((agg) => Object.keys(agg)[0]); // Get aggregate source names
    //     }
    ...
    //         sortedValues.push(entry.values[source] || null);
    //       });
    ...
    //           otherSources.push(entry.values[source]);
    //         }
    //       });

    //       return { metric: entry.metric, values: [...sortedValues, ...otherSources] };
    //     });
    //   }
