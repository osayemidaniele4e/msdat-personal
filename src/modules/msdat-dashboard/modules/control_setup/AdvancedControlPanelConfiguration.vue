...
import AdvancedcontrolSetup from '../../mixins/advanced-control-panel-setup';
...
export default {
  ...
  mixins: [updateQueryParams, AdvancedcontrolSetup],
  data() {
    return {
      interactions: [],
      previous_time: null,
      ...
      async handler() {
        ...
        if (this.payload.indicator) {
          ...
          if (this.controlIndex === 2) {
            ...
            console.log(availableIndicator, 'availableIndicator CON');
            await this.SETUP_CONTROL_OPTIONS1({
              groupIndex: this.groupIndex,
              panelIndex: this.controlIndex,
              key: 'indicator',
