  ...
  <div>
    ...
    <modal-component :modalSize="'lg'" v-model="showModal">
        ...
        <b-tab v-for="(dataSource, index) in dataSources" :key="index">
          ...
          <div class="my-2">
            ...
            <p>
              ...
              <span
                >The percentage of live births in the health facility attended
            ...
            <p>
              ...
              <span>
                <a class="modal-lnk mr-1" href="#"
                  >https://www.samplereport.com,</a
                >
      ...
      <div slot="modal-footer">
        <button
          @click="closeModal"
          class="btn btn-danger text-uppercase small px-4"
        >
          close
        </button>
      </div>
