...
export default {
  ...
  data() {
    return {
      ...
      url4: 'https://public.tableau.com/views/Health_OutcomesdisaggregationHealththink/Dashboard1?:language=en-GB&publish=yes&:display_count=n&:origin=viz_share_link:showVizHome=no&:embed=true',
