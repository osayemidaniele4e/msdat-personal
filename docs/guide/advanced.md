...
The Advanced Anlatyics dashboard accountts for the major analytics done across indicators in the MSDAT dashboard

## Mode of Use

There are 4 core sections in the Advanced Analytics dashboard i.e;
